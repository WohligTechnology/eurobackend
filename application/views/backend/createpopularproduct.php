<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Create popularproduct</h4>
</div>
<form class='col s12' method='post' action='<?php echo site_url("site/createpopularproductsubmit");?>' enctype= 'multipart/form-data'>
<div class="row">
...
<a href="<?php echo site_url("site/viewpopularproduct"); ?>" class="btn btn-secondary waves-effect waves-light red">Cancel</a>
</div>
</div>
</form>
</div>
